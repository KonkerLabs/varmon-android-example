...
const INPUT_PREVIEW = "id:com.google.android.calculator:id/result_preview"
...
const divisionByZeroStep = async () => {
  ...
  const expectedValue = "Impos. dividir por 0";
  ...
  logMessage("Verify input number");
  await getElementAndExpectToBe(INPUT_PREVIEW, expectedValue);
...
export function divisionSpec() {
  describe("Divisao", function() {
    ...
    it("deve trazer a mensagem - 'Impos. dividir por 0' quando houver uma divisao por zero", divisionByZeroStep)
  });
}
